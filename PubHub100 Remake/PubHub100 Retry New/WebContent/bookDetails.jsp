...
<!-- 	Just some stuff you need -->
	...
	%>
		...
		<form name = "form1" method="post" class="form-horizontal">
			...
			<label for="tag_name" class="col-sm-4 control-label">Tag</label>
			<input type="hidden" class="form-control" id="isbn13" name="isbn13" required="required" value="${book.isbn13 }" />
			
			  <div class="col-sm-5">
				<input type="text" class="form-control" id="tag_name" name="tag_name" placeholder="Insert Tag to be added or removed from this book" required = "required"/>
			  </div>
				</br>
				</br>
				</br>
				<button type="submit" class="btn btn-info" formaction = "AddTag">Add Tag</button>
				<button type="submit" class="btn btn-info" formaction = "RemoveTag">Remove Tag</button>
				</form>
